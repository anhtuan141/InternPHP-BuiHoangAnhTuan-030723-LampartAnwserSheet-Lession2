<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Detail Product (<?= $prod->name ?>)</h1>
    <ul class="breadcrumb">
        <li class="breadcrumb-item"><a href="<?= href('product', 'index') ?>"><i class="fas fa-fw fa-tachometer-alt"></i></a></li>
        <li class="breadcrumb-item"><a>Detail Product (<?= $prod->name ?>)</a>
        </li>
    </ul>
    <!-- DataTales Example -->
        ...
        <div class="card-body">
            <form method="POST" action="<?= href('product', 'copyInsert') ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" readonly name="image" value="<?= $prod->image ?>" aria-describedby="emailHelp">
                </div>
